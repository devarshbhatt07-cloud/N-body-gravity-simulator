...
InitialText = text(0.02, 0.98, ['Number of Symplectic Euler cycle: ', num2str(cyclecount)], 'Units', 'Normalized', 'FontSize', 10, 'Color', 'w');
...
GraphTitle = sprintf('Energy Graph of the Symplectic Euler System at %d days',cyclecount);
