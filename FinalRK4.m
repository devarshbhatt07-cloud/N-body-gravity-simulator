...
axis([-35 35 -35 35]);
grid on
title('Solar System Simulator (RK4 Model)','Color', 'w')
...
% Computing the position and velocity acting on every body using rk4calculator function.

[Position,Velocity] = rk4calculator(Mass,Position,Velocity);
...
InitialText = text(0.02, 0.98, ['Number of RK4 cycle: ', num2str(cyclecount)], 'Units', 'Normalized', 'FontSize', 10, 'Color', 'w');
...
GraphTitle = sprintf('Energy Graph of the RK4 System at %d days',cyclecount);
